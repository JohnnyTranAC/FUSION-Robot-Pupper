...
def action(commandType, position):
    if commandType == 1:
        ...
        os.system('omxplayer -o local /home/pi/speech_recognition/sounds/pant_slow.wav')
        print("Pupper has not yet learned to walk\n")
        sleep(1.5)
        
    elif commandType == 4:
        os.system('omxplayer -o local /home/pi/speech_recognition/sounds/pant_fast.wav')
        print("Pupper has not yet learned to run\n")
        sleep(1.5)
        
    elif commandType == 5:
        ### Barking
        os.system('omxplayer -o local /home/pi/speech_recognition/sounds/bark.wav')
